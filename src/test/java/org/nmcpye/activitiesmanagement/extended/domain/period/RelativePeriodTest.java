...
import org.nmcpye.activitiesmanagement.extended.mock.MockI18nFormat;

import java.util.Date;
import java.util.List;

import static org.junit.jupiter.api.Assertions.*;
import static org.nmcpye.activitiesmanagement.extended.analytics.AnalyticsFinancialYearStartKey.FINANCIAL_YEAR_OCTOBER;
...
class RelativePeriodTest {
    ...
    void testGetThisToday() {
        ...
        List<Period> relatives = periods.getRelativePeriods(getDate(2001, 7, 1), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetYesterday() {
        ...
        List<Period> relatives = periods.getRelativePeriods(getDate(2001, 7, 2), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetLast3Days() {
        ...
        List<Period> relatives = periods.getRelativePeriods(getDate(2001, 7, 4), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetLast7Days() {
        ...
        List<Period> relatives = periods.getRelativePeriods(getDate(2001, 7, 8), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetLast14Days() {
        ...
        List<Period> relatives = periods.getRelativePeriods(getDate(2001, 7, 15), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetThisBiWeek() {
        ...
        List<Period> relatives = periods.getRelativePeriods(getDate(2001, 1, 15), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetLast12Months() {
        ...
        List<Period> relatives = periods.getRelativePeriods(getDate(2001, 1, 1), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetLast4Quarters() {
        ...
        List<Period> relatives = relativePeriods.getRelativePeriods(getDate(2001, 1, 1), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetLast4BiWeeks() {
        ...
        List<Period> relatives = relativePeriods.getRelativePeriods(getDate(2002, 1, 1), I18N_FORMAT, false, FINANCIAL_YEAR_OCTOBER);
    ...
    void testGetLast2SixMonths() {
        List<Period> relatives = new RelativePeriods()
