...
/**
 * REST controller for managing {@link org.nmcpye.activitiesmanagement.domain.DataInputPeriod}.
 */
@RestController
@RequestMapping("/api")
public class DataInputPeriodResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/data-input-periods/{id}", consumes = "application/merge-patch+json")
    ...
    public List<DataInputPeriod> getAllDataInputPeriods() {
