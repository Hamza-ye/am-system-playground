...
/**
 * REST controller for managing {@link org.nmcpye.activitiesmanagement.domain.fileresource.FileResource}.
 */
@RestController
@RequestMapping("/api")
public class FileResourceResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/file-resources/{id}", consumes = "application/merge-patch+json")
