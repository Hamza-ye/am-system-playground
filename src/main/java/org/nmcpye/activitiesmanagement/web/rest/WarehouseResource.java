...
/**
 * REST controller for managing {@link org.nmcpye.activitiesmanagement.domain.Warehouse}.
 */
@RestController
@RequestMapping("/api")
public class WarehouseResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/warehouses/{id}", consumes = "application/merge-patch+json")
