...
/**
 * REST controller for managing {@link org.nmcpye.activitiesmanagement.domain.fileresource.ExternalFileResource}.
 */
@RestController
@RequestMapping("/api")
public class ExternalFileResourceResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/external-file-resources/{id}", consumes = "application/merge-patch+json")
