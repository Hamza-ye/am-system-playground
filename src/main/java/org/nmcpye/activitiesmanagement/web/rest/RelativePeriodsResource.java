...
/**
 * REST controller for managing {@link org.nmcpye.activitiesmanagement.domain.RelativePeriods}.
 */
@RestController
@RequestMapping("/api")
public class RelativePeriodsResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/relative-periods/{id}", consumes = "application/merge-patch+json")
