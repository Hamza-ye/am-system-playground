...
/**
 * REST controller for managing {@link org.nmcpye.activitiesmanagement.domain.OrganisationUnitLevel}.
 */
@RestController
@RequestMapping("/api")
public class OrganisationUnitLevelResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/organisation-unit-levels/{id}", consumes = "application/merge-patch+json")
