...
public class RelativePeriods implements Serializable {
    ...
    public List<Period> getRelativePeriods(
        ...
        if (isYesterday()) {
            periods.add(
                getRelativePeriod(new DailyPeriodType(), YESTERDAY, new DateTime(date).minusDays(1).toDate(), dynamicNames, format)
            );
        }
        ...
        if (isLastWeek()) {
            periods.add(
                getRelativePeriod(new WeeklyPeriodType(), LAST_WEEK, new DateTime(date).minusWeeks(1).toDate(), dynamicNames, format)
            );
        }
        ...
        if (isLastBiWeek()) {
            periods.add(
                getRelativePeriod(new BiWeeklyPeriodType(), LAST_BIWEEK, new DateTime(date).minusWeeks(2).toDate(), dynamicNames, format)
            );
        }
        ...
        if (isLastMonth()) {
            periods.add(
                getRelativePeriod(new MonthlyPeriodType(), LAST_MONTH, new DateTime(date).minusMonths(1).toDate(), dynamicNames, format)
            );
        }
        ...
        if (isLastBimonth()) {
            periods.add(
                getRelativePeriod(new BiMonthlyPeriodType(), LAST_BIMONTH, new DateTime(date).minusMonths(2).toDate(), dynamicNames, format)
            );
        }
        ...
        if (isLastQuarter()) {
            periods.add(
                getRelativePeriod(new QuarterlyPeriodType(), LAST_QUARTER, new DateTime(date).minusMonths(3).toDate(), dynamicNames, format)
            );
        }
