...
import org.nmcpye.activitiesmanagement.extended.common.calendar.DateInterval;
import org.nmcpye.activitiesmanagement.extended.common.calendar.DateIntervalType;
...
public abstract class WeeklyAbstractPeriodType extends CalendarPeriodType {
    ...
    protected WeeklyAbstractPeriodType(
        String name,
        int startOfWeek,
        String isoFormat,
        String isoDuration,
    ...
    public String getIsoDate(DateTimeUnit dateTimeUnit, Calendar calendar) {
        ...
        if (calendar.isIso8601()) {
            ...
            WeekFields weekFields = WeekFields.of(MAP_WEEK_TYPE.get(getName()), 4);
