...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Project.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Project.class.getName() + ".activities");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Activity.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Activity.class.getName() + ".warehouses");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DemographicData.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DemographicDataSource.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DemographicDataSource.class.getName() + ".demographicData");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Person.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Person.class.getName() + ".organisationUnits");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Person.class.getName() + ".dataViewOrganisationUnits");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Person.class.getName() + ".personAuthorityGroups");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Person.class.getName() + ".groups");
            ...
            createCache(cm, org.nmcpye.activitiesmanagement.domain.PeriodType.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.Period.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.MalariaCasesReport.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DengueCasesReport.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.CasesReportClass.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.CHV.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.CHV.class.getName() + ".coveredSubVillages");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.CHV.class.getName() + ".supervisionTeams");
            ...
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName() + ".malariaReports");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName() + ".dengueReports");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName() + ".children");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName() + ".demographicData");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName() + ".groups");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName() + ".people");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName() + ".dataViewPeople");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnit.class.getName() + ".dataSets");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnitGroup.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnitGroup.class.getName() + ".members");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnitGroup.class.getName() + ".groupSets");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnitGroupSet.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnitGroupSet.class.getName() + ".organisationUnitGroups");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.OrganisationUnitLevel.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.PeopleGroup.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.PeopleGroup.class.getName() + ".members");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.PeopleGroup.class.getName() + ".managedByGroups");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.PeopleGroup.class.getName() + ".managedGroups");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.PersonAuthorityGroup.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.PersonAuthorityGroup.class.getName() + ".members");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DataSet.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DataSet.class.getName() + ".malariaCasesReports");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DataSet.class.getName() + ".dengueCasesReports");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DataSet.class.getName() + ".sources");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.DataInputPeriod.class.getName());
            createCache(cm, org.nmcpye.activitiesmanagement.domain.RelativePeriods.class.getName());
