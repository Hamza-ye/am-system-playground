...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, WhMovement.class.getName());
            ...
            createCache(cm, LlinsVillageTarget.class.getName());
            createCache(cm, LlinsVillageTarget.class.getName() + ".llinsVillageReports");
            createCache(cm, org.nmcpye.activitiesmanagement.domain.StatusOfCoverage.class.getName());
            createCache(cm, LlinsFamilyTarget.class.getName());
            createCache(cm, LlinsFamilyTarget.class.getName() + ".llinsFamilyReports");
            createCache(cm, LlinsFamilyReport.class.getName());
            createCache(cm, LlinsFamilyReport.class.getName() + ".llinsFamilyReportHistories");
            createCache(cm, LlinsVillageReport.class.getName());
            createCache(cm, LlinsVillageReport.class.getName() + ".llinsVillageReportHistories");
            createCache(cm, LlinsFamilyReportHistory.class.getName());
            createCache(cm, LlinsVillageReportHistory.class.getName());
            ...
            createCache(cm, ChvTeam.class.getName());
            createCache(cm, ChvTeam.class.getName() + ".responsibleForChvs");
            createCache(cm, ChvMalariaReportVersion1.class.getName());
            createCache(cm, ChvMalariaCaseReport.class.getName());
