package org.nmcpye.activitiesmanagement.extended.util;
...
public class DateUtils {
    ...
    private static final DateTimeFormatter DATE_FORMATTER = new DateTimeFormatterBuilder()
        .append(null, SUPPORTED_DATE_FORMAT_PARSERS)
        .toFormatter();
     ...
     * @return true/false depending on whether the string is a date according to the format "yyyy-MM-dd".
     */
    public static boolean dateIsValid(org.nmcpye.activitiesmanagement.extended.common.calendar.Calendar calendar, String dateString) {
    ...
    /**
     * Creates a {@link Date} from the given {@link LocalDateTime}
    ...
    /**
     * Parses the given string into a {@link Duration} object. The
    ...
    public static Date getLatest(Date... dates) {
        return Lists.newArrayList(dates).stream().filter(Objects::nonNull).max(Date::compareTo).orElse(null);
    }
