 ...
 */
public class DengueCasesReportStoreImpl
    extends HibernateIdentifiableObjectStore<DengueCasesReport>
    implements DengueCasesReportStore {
    // -------------------------------------------------------------------------
    // Dependencies
    // -------------------------------------------------------------------------

    public DengueCasesReportStoreImpl(JdbcTemplate jdbcTemplate, ApplicationEventPublisher publisher,
                                      UserService userService, AclService aclService) {
        super(jdbcTemplate, publisher, DengueCasesReport.class, userService, aclService, true);
    }
}
