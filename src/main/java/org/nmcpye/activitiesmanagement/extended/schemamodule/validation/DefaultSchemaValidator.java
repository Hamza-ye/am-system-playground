package org.nmcpye.activitiesmanagement.extended.schemamodule.validation;
...
@Service("org.nmcpye.activitiesmanagement.extended.schemamodule.validation.SchemaValidator")
    ...
    public List<ErrorReport> validate(Object object, boolean persisted, Class<?> mainErrorClass) {
        ...
        if (object instanceof User) {
            ...
            if (user.getPerson() != null) {
                errors.addAll(validate(user.getPerson(), persisted));
            }
        }
        return errors;
    }
