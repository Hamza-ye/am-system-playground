...
public enum ValueType {
    ...
    public static final Set<ValueType> DECIMAL_TYPES = ImmutableSet.of(NUMBER, UNIT_INTERVAL, PERCENTAGE);

    public static final Set<ValueType> BOOLEAN_TYPES = ImmutableSet.of(BOOLEAN, TRUE_ONLY);

    public static final Set<ValueType> TEXT_TYPES = ImmutableSet.of(TEXT, LONG_TEXT, LETTER, TIME, USERNAME, EMAIL, PHONE_NUMBER, URL);

    public static final Set<ValueType> DATE_TYPES = ImmutableSet.of(DATE, DATETIME, AGE);

    public static final Set<ValueType> FILE_TYPES = ImmutableSet.of(FILE_RESOURCE, IMAGE);

    //    public static final Set<ValueType> GEO_TYPES = ImmutableSet.of(
    //        COORDINATE );

    public static final Set<ValueType> NUMERIC_TYPES = ImmutableSet
        .<ValueType>builder()
