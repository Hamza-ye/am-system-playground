...
public class DimensionalObjectUtils {
    ...
    public static String getName(List<DimensionalItemObject> objects) {
        return objects.stream().map(DimensionalItemObject::getShortName).collect(Collectors.joining(COL_SEP));
    }
     ...
     */
    public static Map<DimensionalItemObject, Double> convertToDimItemValueMap(List<DimensionItemObjectValue> dimensionItemObjectValues) {
        return dimensionItemObjectValues
            .stream()
            .filter(item -> item.getValue() != null)
            .collect(Collectors.toMap(DimensionItemObjectValue::getDimensionalItemObject, DimensionItemObjectValue::getValue));
    }
}
