...
public class ReflectionUtils {
    ...
    public static final List<String> SHARING_PROPS = Arrays.asList("publicAccess", "externalAccess", "userGroupAccesses", "userAccesses");
    ...
    public static Method findGetterMethod(String fieldName, Class<?> clazz) {
        String[] getterNames = new String[] { "get", "is", "has" };
    ...
    public static Method findSetterMethod(String fieldName, Object target) {
        ...
        String[] setterNames = new String[] { "set" };
