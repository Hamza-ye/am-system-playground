...
public class IdScheme {
    ...
    public static final ImmutableMap<IdentifiableProperty, IdScheme> IDPROPERTY_IDSCHEME_MAP = ImmutableMap
        .<IdentifiableProperty, IdScheme>builder()
    ...
    public static IdScheme from(IdentifiableProperty property) {
        ...
        return IDPROPERTY_IDSCHEME_MAP.containsKey(property) ? IDPROPERTY_IDSCHEME_MAP.get(property) : new IdScheme(property);
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("identifiableProperty", identifiableProperty).add("attribute", attribute).toString();
    }
}
