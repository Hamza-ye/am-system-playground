...
describe('Service Tests', () => {
  describe('OrganisationUnitLevel routing resolve service', () => {
    ...
    let resultOrganisationUnitLevel: IOrganisationUnitLevel | undefined;
    ...
    describe('resolve', () => {
      ...
      it('should return new IOrganisationUnitLevel if id is not provided', () => {
        // GIVEN
        ...
        expect(resultOrganisationUnitLevel).toEqual(new OrganisationUnitLevel());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as OrganisationUnitLevel })));
        mockActivatedRouteSnapshot.params = { id: 123 };
