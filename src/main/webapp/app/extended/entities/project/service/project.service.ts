...
import { IProject, getProjectIdentifier } from '../../../../entities/project/project.model';
...
export class ProjectService {
  ...
  protected convertDateFromClient(project: IProject): IProject {
    return Object.assign({}, project, {
      created: project.created?.isValid() ? project.created.toJSON() : undefined,
      lastUpdated: project.lastUpdated?.isValid() ? project.lastUpdated.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((project: IProject) => {
        project.created = project.created ? dayjs(project.created) : undefined;
        project.lastUpdated = project.lastUpdated ? dayjs(project.lastUpdated) : undefined;
      });
    }
    return res;
  }
